...
export const customerPortalApi = {
  ...
  getServiceAgreements: () => api().get(`${isProviderPortal() ? `customer-portal/agreements?customer_id=${authStore.customerId}` : 'customer-portal/agreements'}`).then(unwrap),
  getMaintenanceAgreements: () => api().get(`${isProviderPortal() ? `maintenance-agreement-management/agreements?customer_id=${authStore.customerId}` : 'maintenance-agreement-management/agreements'}`).then(unwrap),
