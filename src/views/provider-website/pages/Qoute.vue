<template>
  <div class="container mx-auto m-6 p-4 rounded-lg bg-cyan-50 ">
    <!-- Page Header -->
    <div class="mb-6 flex flex-col md:flex-row md:items-center md:justify-between">
      <div>
        <h1 class="text-2xl font-bold text-gray-900">Register as a Customer</h1>
        <p class="mt-1 text-sm text-gray-500">Create a new customer profile for pool service management.</p>
      </div>
      <div class="mt-4 flex space-x-3 md:mt-0">
        <button 
          @click="handleCancel" 
          class="rounded-lg border cursor-pointer border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
        >
