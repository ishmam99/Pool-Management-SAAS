<template>
  <div class="p-6 mx-auto">
    ...
    <div class="flex items-center gap-4 mb-6">
      <button
        @click="$router.back()"
        class="inline-flex items-center gap-1 border px-2 py-1 rounded-xl hover:bg-indigo-600 hover:text-white text-indigo-600 hover:text-indigo-800 transition"
      >
