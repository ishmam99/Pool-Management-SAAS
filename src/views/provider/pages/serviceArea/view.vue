      ...
      <table class="min-w-full divide-y divide-gray-200 table-zebra">
        <thead class="bg-blue-100">
          <tr>
            ...
            <th class="px-6 py-3 border-e border-slate-300 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">City</th>
            <th class="px-6 py-3 border-e border-slate-300 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">State</th>
            <th class="px-6 py-3 border-e border-slate-300 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">ZIP</th>
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          <tr v-for="(area, index) in areas" :key="area.id">
            ...
            <td class="px-6 py-4 border-e border-slate-200 whitespace-nowrap text-sm text-gray-900">{{ area.city }}</td>
            <td class="px-6 py-4 border-e border-slate-200 whitespace-nowrap text-sm text-gray-900">{{ area.state }}</td>
            <td class="px-6 py-4 border-e border-slate-200 whitespace-nowrap text-sm text-gray-900">{{ area.zip_code || '-' }}</td>
            ...
            <td class="px-6 py-4 border-e border-slate-200 whitespace-nowrap text-sm text-gray-500">{{ area.order_index ?? 0 }}</td>
