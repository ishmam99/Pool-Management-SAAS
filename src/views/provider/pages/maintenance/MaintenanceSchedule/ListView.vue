<template>
  <div class=" px-4 sm:px-6 lg:px-8 py-6 font-sans text-gray-800">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
      <div>
        <h1 class="text-2xl font-bold text-gray-900">Schedule Maintenance Visits</h1>
        <p class="text-sm text-gray-500 mt-0.5">Manage scheduled pool maintenance visits, technicians, priorities, and visit
          statuses.</p>
      </div>
