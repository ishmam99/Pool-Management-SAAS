    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-slate-100 via-blue-50 to-slate-100 border-b border-slate-200">
      ...
      <div class="relative max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          ...
          <!-- Action Buttons -->
          <div class="flex items-center gap-2">
            <button @click="handleRefresh" class="flex items-center gap-2 px-3 py-2 rounded-xl text-sm font-medium text-slate-600 bg-white hover:bg-slate-50 border border-slate-200 transition-all duration-200 hover:border-slate-300 shadow-sm">
            ...
            <button class="flex items-center gap-2 px-3 py-2 rounded-xl text-sm font-medium text-slate-600 bg-white hover:bg-slate-50 border border-slate-200 transition-all duration-200 hover:border-slate-300 shadow-sm">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/>
              </svg>
              <span class="hidden sm:inline">Export</span>
            </button>
            <button @click="openAddModal" class="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 shadow-lg shadow-blue-500/25 transition-all duration-200 hover:shadow-blue-500/40 hover:-translate-y-0.5">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4">
          <!-- Total Pools -->
          <div class="group relative overflow-hidden rounded-2xl bg-white border border-slate-200 p-4 hover:border-blue-300 transition-all duration-300 hover:shadow-lg hover:shadow-blue-100 hover:-translate-y-0.5 cursor-default">
            <div class="absolute -top-4 -right-4 w-20 h-20 rounded-full bg-blue-400/10 blur-xl group-hover:bg-blue-400/20 transition-all duration-300"></div>
            <div class="relative">
              <div class="flex items-center justify-between mb-3">
                ...
                <span class="flex items-center gap-1 text-xs font-medium text-emerald-600">
                  <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7 7 7"/></svg>
                  12%
                </span>
              </div>
          ...
          <!-- Active Pools -->
          <div class="group relative overflow-hidden rounded-2xl bg-white border border-slate-200 p-4 hover:border-emerald-300 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-100 hover:-translate-y-0.5 cursor-default">
            <div class="absolute -top-4 -right-4 w-20 h-20 rounded-full bg-emerald-400/10 blur-xl group-hover:bg-emerald-400/20 transition-all duration-300"></div>
            <div class="relative">
              <div class="flex items-center justify-between mb-3">
                <div class="flex items-center justify-center w-9 h-9 rounded-xl bg-emerald-100 border border-emerald-200">
          ...
          <!-- Inactive Pools -->
          <div class="group relative overflow-hidden rounded-2xl bg-white border border-slate-200 p-4 hover:border-rose-300 transition-all duration-300 hover:shadow-lg hover:shadow-rose-100 hover:-translate-y-0.5 cursor-default">
            <div class="absolute -top-4 -right-4 w-20 h-20 rounded-full bg-rose-400/10 blur-xl group-hover:bg-rose-400/20 transition-all duration-300"></div>
            <div class="relative">
              <div class="flex items-center justify-between mb-3">
                ...
                <span class="flex items-center gap-1 text-xs font-medium text-rose-600">
                  <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7-7-7"/></svg>
                  3%
                </span>
              </div>
          ...
          <!-- Equipment -->
          <div class="group relative overflow-hidden rounded-2xl bg-white border border-slate-200 p-4 hover:border-violet-300 transition-all duration-300 hover:shadow-lg hover:shadow-violet-100 hover:-translate-y-0.5 cursor-default">
            <div class="absolute -top-4 -right-4 w-20 h-20 rounded-full bg-violet-400/10 blur-xl group-hover:bg-violet-400/20 transition-all duration-300"></div>
            <div class="relative">
              <div class="flex items-center justify-between mb-3">
      ...
      <div v-else-if="filteredPools.length > 0" class="md:hidden space-y-3">
        ...
        >
          ...
          <div class="flex items-center gap-2 pt-3 border-t border-slate-100" @click.stop>
            ...
            <button @click="openEditModal(pool)" class="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-xl text-xs font-semibold bg-slate-50 text-slate-600 hover:bg-amber-50 hover:text-amber-600 border border-slate-200 hover:border-amber-300 transition-all">
              <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
              Edit
            </button>
            <button @click="confirmDelete(pool)" class="flex items-center justify-center w-9 h-9 rounded-xl bg-slate-50 text-rose-600 border border-slate-200 hover:bg-rose-50 hover:border-rose-300 transition-all">
              <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>
            </button>
          </div>
        </div>
